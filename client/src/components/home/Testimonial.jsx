...
const Testimonial = () => {
  ...
  <> 
    <div>
        <div id='testimonial' className='flex flex-col items-center my-10 scroll-mt-12'></div>
        ...
        users say about us. We're always looking for ways to improve. If you have a positive experience with us, leave a review."/>
    </div>
